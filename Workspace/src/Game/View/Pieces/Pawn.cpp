...
void View::Pawn::draw()
{
    ...
    // Some dirty calculations here!
    {
        ...
        _modelMatrix = glm::translate( _modelMatrix, glm::vec3(PIECE_OFFSET * (_position._x), PIECE_Y_OFFSET * _position._y, 0.0f) ); 
        _modelMatrix = glm::translate( _modelMatrix, glm::vec3(-BOARD_SIZE, -BOARD_SIZE, 0.0f) );                 
